...
@Injectable({
  ...
  export class CarrelloService {
    ...
    public updateCart(csrftoken : string, carrello : Carrello) : Observable<any> {
        ...
        console.log('updateCart-carrello.Matnr:' + carrello.Matnr);
        console.log('updateCart-encoded:' + encodeURIComponent(carrello.Matnr));
        console.log('updateCart-matrn:' + matrn);
